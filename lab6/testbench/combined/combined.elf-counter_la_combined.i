# 0 "counter_la_combined.c"
# 1 "/home/ubuntu/workspace/SOC_lab/lab/lab6/lab-wlos_baseline/testbench/combined//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_combined.c"
# 19 "counter_la_combined.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 21 "counter_la_combined.c" 2
# 1 "../../firmware/user_uart.h" 1
# 22 "counter_la_combined.c" 2
...
# 51 "counter_la_combined.c"
void main()
{

    int mask;
# 82 "counter_la_combined.c"
 ...
 while (count < 1) {
  count++;
  (*(volatile uint32_t*)0x2600000c) = 0xAB810000;
 }
