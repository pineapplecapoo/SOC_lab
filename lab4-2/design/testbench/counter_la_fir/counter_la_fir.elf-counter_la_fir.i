# 0 "counter_la_fir.c"
# 1 "/home/ubuntu/workspace/SOC_lab/lab/lab4_2/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_fir.c"
# 19 "counter_la_fir.c"
...
# 141 "counter_la_fir.c"
(*(volatile uint32_t*)0x30000010) = 64;

(*(volatile uint32_t*)0x30000020) = taps[0];
(*(volatile uint32_t*)0x30000024) = taps[1];
(*(volatile uint32_t*)0x30000028) = taps[2];
(*(volatile uint32_t*)0x3000002c) = taps[3];
(*(volatile uint32_t*)0x30000030) = taps[4];
(*(volatile uint32_t*)0x30000034) = taps[5];
(*(volatile uint32_t*)0x30000038) = taps[6];
(*(volatile uint32_t*)0x3000003c) = taps[7];
(*(volatile uint32_t*)0x30000040) = taps[8];
(*(volatile uint32_t*)0x30000044) = taps[9];
(*(volatile uint32_t*)0x30000048) = taps[10];
 ...
 for(int i=0; i<3; i++){
  ...
  (*(volatile uint32_t*)0x2600000c) = (*tmp << 24) | (0x5A << 16);
 }
