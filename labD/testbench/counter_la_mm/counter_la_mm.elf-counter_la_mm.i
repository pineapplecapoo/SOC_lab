# 0 "counter_la_mm.c"
# 1 "/home/ubuntu/workspace/SOC_lab/lab/labD/lab-sdram/testbench/counter_la_mm//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_mm.c"
# 19 "counter_la_mm.c"
...
extern int* __attribute__ ( ( section ( ".mprjram" ) ) ) matmul();
extern int __attribute__ ( ( section ( ".mprjram" ) ) ) test();
# 35 "counter_la_mm.c"
void main()
{
 int j;
...
int __attribute__ ( ( section ( ".mprjram" ) ) ) test(){


 (*(volatile uint32_t*)0x2600000c) = *matmul() << 16;
 (*(volatile uint32_t*)0x2600000c) = *matmul()+1 << 16;
 (*(volatile uint32_t*)0x2600000c) = *matmul()+2 << 16;

 (*(volatile uint32_t*)0x2600000c) = *matmul()+3 << 16;




 (*(volatile uint32_t*)0x2600000c) = *matmul()+9 << 16;
