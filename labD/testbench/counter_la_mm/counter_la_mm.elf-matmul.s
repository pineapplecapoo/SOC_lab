...
.Ltext0:
	...
	.file 0 "/home/ubuntu/workspace/SOC_lab/lab/labD/lab-sdram/testbench/counter_la_mm" "matmul.c"
	.globl	A
	.data
	.align	2
	.type	A, @object
...
.L4:
	...
	li	a5,3
	ble	a4,a5,.L5
	.loc 1 18 13 discriminator 2
	lw	a5,-20(s0)
	slli	a4,a5,2
	.loc 1 18 17 discriminator 2
	lw	a5,-24(s0)
	add	a5,a4,a5
	.loc 1 18 22 discriminator 2
	lui	a4,%hi(result)
...
.LASF0:
	.string	"matmul.c"
.LASF1:
	.string	"/home/ubuntu/workspace/SOC_lab/lab/labD/lab-sdram/testbench/counter_la_mm"
